...
letter_uniqueness = [("J", 95), ("Q", 90), ("X", 88), ("Z", 85), ("A", 82), ("W", 80), ("M", 78), ("K", 75), ("S", 73), ("Y", 70), ("H", 68), ("N", 65), ("R", 62), ("G", 60), ("B", 58), ("P", 55), ("V", 52), ("U", 50), ("E", 48), ("C", 45), ("D", 42), ("F", 40), ("T", 38), ("L", 32), ("O", 28), ("I", 20)]

sort!(letter_uniqueness, by = last, rev = true)

verticals = ("H", "I", "N", "O", "S", "X", "Z", "M", "W")

filter!(x -> first(x) ∉ verticals, letter_uniqueness)
